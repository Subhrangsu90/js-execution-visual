...
export const icons = {
  jsBadge: (size = 28) => `
    <svg width="${size}" height="${size}" viewBox="0 0 256 256" fill="none" xmlns="http://www.w3.org/2000/svg" style="border-radius:6px; box-shadow: 0 2px 8px rgba(247, 223, 30, 0.35);">
